...
# =========== 1. Carga el DataFrame desde el CSV ===========
df = pd.read_csv('data_dashboard.csv')

# =========== 2. Sidebar: Filtros dinámicos ===========
...
# =========== 4. Balanced Scorecard con semáforos ===========

# 1 = verde/meta lograda, 2 = amarillo/parcial, 3 = rojo/meta no lograda
...
# Meta por KPI y Scorecard
df_f['Meta ROI'] = 0.15
df_f['Meta Automatizacion'] = 5
df_f['Meta Defectos'] = 2

st.header("Balanced Scorecard y OKRs (con metas y semáforo)")
cols = ["Proyecto", "Cliente", "ROI", "Meta ROI", "Automatizacion", "Meta Automatizacion", "Defectos", "Meta Defectos", "Crecimiento", "OKR"]
